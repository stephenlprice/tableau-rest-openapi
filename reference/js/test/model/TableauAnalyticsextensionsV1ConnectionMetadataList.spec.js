...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMetadataList();
  });
  ...
  describe('TableauAnalyticsextensionsV1ConnectionMetadataList', function() {
    it('should create an instance of TableauAnalyticsextensionsV1ConnectionMetadataList', function() {
      // uncomment below and update the code to test TableauAnalyticsextensionsV1ConnectionMetadataList
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMetadataList();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMetadataList);
    });

    it('should have the property connectionMetadataList (base name: "connectionMetadataList")', function() {
      // uncomment below and update the code to test the property connectionMetadataList
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMetadataList();

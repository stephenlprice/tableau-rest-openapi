...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings();
  });
  ...
  describe('TableauExtensionsDashboardV1SiteSettings', function() {
    it('should create an instance of TableauExtensionsDashboardV1SiteSettings', function() {
      // uncomment below and update the code to test TableauExtensionsDashboardV1SiteSettings
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings);
    });

    it('should have the property extensionsEnabled (base name: "extensions_enabled")', function() {
      // uncomment below and update the code to test the property extensionsEnabled
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings();
      //expect(instance).to.be();
    });

    it('should have the property allowSandboxed (base name: "allow_sandboxed")', function() {
      // uncomment below and update the code to test the property allowSandboxed
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings();
      //expect(instance).to.be();
    });

    it('should have the property safeListItems (base name: "safe_list_items")', function() {
      // uncomment below and update the code to test the property safeListItems
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SiteSettings();
      //expect(instance).to.be();
    });

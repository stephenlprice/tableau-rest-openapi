...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionList();
  });
  ...
  describe('TableauAnalyticsextensionsV1ConnectionList', function() {
    it('should create an instance of TableauAnalyticsextensionsV1ConnectionList', function() {
      // uncomment below and update the code to test TableauAnalyticsextensionsV1ConnectionList
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionList();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionList);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1ServerSettings();
  });
  ...
  describe('TableauExtensionsDashboardV1ServerSettings', function() {
    it('should create an instance of TableauExtensionsDashboardV1ServerSettings', function() {
      // uncomment below and update the code to test TableauExtensionsDashboardV1ServerSettings
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1ServerSettings();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1ServerSettings);
    });

    it('should have the property blockListItems (base name: "block_list_items")', function() {
      // uncomment below and update the code to test the property blockListItems
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1ServerSettings();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SafeListItems();
  });
  ...
  describe('TableauExtensionsDashboardV1SafeListItems', function() {
    it('should create an instance of TableauExtensionsDashboardV1SafeListItems', function() {
      // uncomment below and update the code to test TableauExtensionsDashboardV1SafeListItems
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SafeListItems();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1SafeListItems);
    });

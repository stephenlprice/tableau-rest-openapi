...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMapping();
  });
  ...
  describe('TableauAnalyticsextensionsV1ConnectionMapping', function() {
    it('should create an instance of TableauAnalyticsextensionsV1ConnectionMapping', function() {
      // uncomment below and update the code to test TableauAnalyticsextensionsV1ConnectionMapping
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMapping();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMapping);
    });

    it('should have the property workbookLuid (base name: "workbook_luid")', function() {
      // uncomment below and update the code to test the property workbookLuid
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1ConnectionMapping();

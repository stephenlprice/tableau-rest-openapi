...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItems();
  });
  ...
  describe('TableauExtensionsDashboardV1BlockListItems', function() {
    it('should create an instance of TableauExtensionsDashboardV1BlockListItems', function() {
      // uncomment below and update the code to test TableauExtensionsDashboardV1BlockListItems
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItems();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItems);
    });

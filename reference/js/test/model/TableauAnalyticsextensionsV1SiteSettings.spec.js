...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1SiteSettings();
  });
  ...
  describe('TableauAnalyticsextensionsV1SiteSettings', function() {
    it('should create an instance of TableauAnalyticsextensionsV1SiteSettings', function() {
      // uncomment below and update the code to test TableauAnalyticsextensionsV1SiteSettings
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1SiteSettings();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauAnalyticsextensionsV1SiteSettings);
    });

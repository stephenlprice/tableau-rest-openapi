...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItem();
  });
  ...
  describe('TableauExtensionsDashboardV1BlockListItem', function() {
    it('should create an instance of TableauExtensionsDashboardV1BlockListItem', function() {
      // uncomment below and update the code to test TableauExtensionsDashboardV1BlockListItem
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItem();
      //expect(instance).to.be.a(ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItem);
    });
    ...
    it('should have the property blockListItemLuid (base name: "block_list_item_luid")', function() {
      // uncomment below and update the code to test the property blockListItemLuid
      //var instance = new ApiReferenceForTableauResourceVersionedResTfulEndpoints.TableauExtensionsDashboardV1BlockListItem();
      //expect(instance).to.be();
    });
